-- =====================================================================
-- تعيين موظفي الإدارة لورشة الإدارة
-- شغّله بالأمر:
--   mysql -h 127.0.0.1 -u DB_USER -pDB_PASS DB_NAME < scripts/set_workshop_admin.sql
-- =====================================================================

-- إنشاء ورشة الإدارة إن لم تكن موجودة
INSERT INTO workshops (id, name, description)
SELECT UUID(), 'الإدارة', 'قسم الإدارة'
WHERE NOT EXISTS (SELECT 1 FROM workshops WHERE name = 'الإدارة');

-- تعيين الموظفين لورشة الإدارة
UPDATE employees e
